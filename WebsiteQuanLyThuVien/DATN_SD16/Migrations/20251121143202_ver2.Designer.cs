            ...
            modelBuilder.Entity("DATN_SD16.Models.Entities.Role", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            RoleId = 1,
                            CreatedAt = new DateTime(2025, 11, 21, 21, 32, 1, 890, DateTimeKind.Local).AddTicks(7963),
                            Description = "Quản trị viên hệ thống - Toàn quyền quản lý",
                            RoleName = "Admin",
                            UpdatedAt = new DateTime(2025, 11, 21, 21, 32, 1, 890, DateTimeKind.Local).AddTicks(7965)
                        },
                        new
                        {
                            RoleId = 2,
                            CreatedAt = new DateTime(2025, 11, 21, 21, 32, 1, 890, DateTimeKind.Local).AddTicks(7969),
                            Description = "Thủ thư - Quản lý mượn trả, kho sách",
                            RoleName = "Librarian",
                            UpdatedAt = new DateTime(2025, 11, 21, 21, 32, 1, 890, DateTimeKind.Local).AddTicks(7970)
                        },
                        new
                        {
                            RoleId = 3,
                            CreatedAt = new DateTime(2025, 11, 21, 21, 32, 1, 890, DateTimeKind.Local).AddTicks(7975),
                            Description = "Độc giả - Mượn sách, tìm kiếm",
                            RoleName = "Reader",
                            UpdatedAt = new DateTime(2025, 11, 21, 21, 32, 1, 890, DateTimeKind.Local).AddTicks(7976)
                        });
                });
            ...
            modelBuilder.Entity("DATN_SD16.Models.Entities.SystemSetting", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            SettingValue = "14",
                            UpdatedAt = new DateTime(2025, 11, 21, 21, 32, 1, 890, DateTimeKind.Local).AddTicks(8572)
                        },
                        new
                        {
                            SettingId = 2,
                            ...
                            SettingValue = "7",
                            UpdatedAt = new DateTime(2025, 11, 21, 21, 32, 1, 890, DateTimeKind.Local).AddTicks(8576)
                        },
                        new
                        {
                            SettingId = 3,
                            ...
                            SettingValue = "5",
                            UpdatedAt = new DateTime(2025, 11, 21, 21, 32, 1, 890, DateTimeKind.Local).AddTicks(8579)
                        },
                        new
                        {
                            SettingId = 4,
                            ...
                            SettingValue = "5000",
                            UpdatedAt = new DateTime(2025, 11, 21, 21, 32, 1, 890, DateTimeKind.Local).AddTicks(8583)
                        },
                        new
                        {
                            SettingId = 5,
                            ...
                            SettingValue = "3",
                            UpdatedAt = new DateTime(2025, 11, 21, 21, 32, 1, 890, DateTimeKind.Local).AddTicks(8595)
                        },
                        new
                        {
                            SettingId = 6,
                            ...
                            SettingValue = "2",
                            UpdatedAt = new DateTime(2025, 11, 21, 21, 32, 1, 890, DateTimeKind.Local).AddTicks(8607)
                        },
                        new
                        {
                            SettingId = 7,
                            ...
                            SettingValue = "1",
                            UpdatedAt = new DateTime(2025, 11, 21, 21, 32, 1, 890, DateTimeKind.Local).AddTicks(8636)
                        });
                });
            ...
            modelBuilder.Entity("DATN_SD16.Models.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2025, 11, 21, 21, 32, 2, 153, DateTimeKind.Local).AddTicks(7054),
                            ...
                            IsActive = true,
                            IsLocked = false,
                            PasswordHash = "$2a$11$lmE8HgitRYpxYn.SGlONsevLOmia6Z37xc1aoUk.9BnCSq1W8H2BC",
                            PhoneNumber = "0123456789",
                            UpdatedAt = new DateTime(2025, 11, 21, 21, 32, 2, 153, DateTimeKind.Local).AddTicks(7079),
                            Username = "admin"
                        },
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2025, 11, 21, 21, 32, 2, 416, DateTimeKind.Local).AddTicks(5433),
                            ...
                            IsActive = true,
                            IsLocked = false,
                            PasswordHash = "$2a$11$HxabxufC9yXNri9QRKAN4.VD9eixZikNkWb0aamR1aKTp3VDfYxBK",
                            PhoneNumber = "0987654321",
                            UpdatedAt = new DateTime(2025, 11, 21, 21, 32, 2, 416, DateTimeKind.Local).AddTicks(5451),
                            Username = "john_doe"
                        });
                });
